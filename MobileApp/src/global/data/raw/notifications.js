const notifications = [
  {
    id: 1,
    type: 'follow',
    description: 'Your issue with Patrick Scout has been reopened',
    time: -1,
  }, {
    id: 2,
    type: 'like',
    description: 'You have a new issue with Hallen Keller',
    time: -271,
  //  attach: require('../../assets/img/Image8.png'),
  }, {
    id: 3,
    type: 'like',
    description: 'Your issue with John Doe has been closed',
    time: -541,
    //attach: require('../../assets/img/Image8.png'),
  },
  // {
