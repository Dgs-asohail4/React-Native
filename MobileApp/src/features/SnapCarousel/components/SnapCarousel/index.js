...
import { sliderWidth, itemWidth } from '../../../../components/SlideEntry/styles';
import SliderEntry from '../../../../components/SlideEntry/container';
import StyleSheetFactory, { colors } from './styles';
import { data } from '../../../../global/data';
import { scrollInterpolators, animatedStyles } from '../../../../utils/animations';
import { DEFUALT_THEME } from '../../../../global/config';
const IS_ANDROID = Platform.OS === 'android';
const SLIDER_1_FIRST_ITEM = 1;
const styles = StyleSheetFactory.getSheet(Theme[DEFUALT_THEME])
const {ENTRIES1, ENTRIES2} = data.getEntries();
